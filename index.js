...
const questions = [
    ...
    },
    {
        type: "input",
        name: "text-color",
        message: "TEXT COLOR: Enter a color keyword or hex:",
    },
    {
        type: "input",
        name: "shape",
        message: "SHAPE COLOR: Enter a color keyword or hex:",
    },
    {
        type: "list",
        name: "pixel-image",
...
async function init() {
	...
	if (answers.text.length > 0 && answers.text.length < 4) {
		...
		console.log("Please retry and enter 3 Characters");
        return;
	}
	...
	console.log("Entered shape = [" + user_shape_type + "]");
